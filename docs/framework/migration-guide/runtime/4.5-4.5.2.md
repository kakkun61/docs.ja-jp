---
title: .NET Framework 4.5 から 4.5.2 への移行に関するランタイム変更
description: .NET Framework 4.5 から 4.5.2 に移行するときに、ランタイムの変更からのアプリに影響する可能性があるアプリケーションの互換性の問題に関する情報を確認します。
ms.date: 07/10/2019
...
ms.locfileid: "97009125"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-452"></a><span data-ttu-id="06883-103">.NET Framework 4.5 から 4.5.2 への移行に関するランタイム変更</span><span class="sxs-lookup"><span data-stu-id="06883-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.5.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="06883-104">.NET Framework 4.5 から 4.5.2 に移行する場合は、アプリに影響する可能性があるアプリケーションの互換性の問題に関する次のトピックを確認してください。</span><span class="sxs-lookup"><span data-stu-id="06883-104">If you are migrating from the .NET Framework 4.5 to 4.5.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="06883-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="06883-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="06883-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="06883-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="06883-107">コア</span><span class="sxs-lookup"><span data-stu-id="06883-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="06883-108">データ</span><span class="sxs-lookup"><span data-stu-id="06883-108">Data</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="06883-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="06883-109">Entity Framework</span></span>
...
## <a name="serialization"></a><span data-ttu-id="06883-110">シリアル化</span><span class="sxs-lookup"><span data-stu-id="06883-110">Serialization</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="06883-111">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="06883-111">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="06883-112">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="06883-112">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="06883-113">XML</span><span class="sxs-lookup"><span data-stu-id="06883-113">XML</span></span>
