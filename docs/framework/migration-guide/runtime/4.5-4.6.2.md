---
title: .NET Framework 4.5 から 4.6.2 への移行に関するランタイム変更
description: .NET Framework 4.5 から 4.6.2 に移行するときに、ランタイムの変更からのアプリに影響する可能性があるアプリケーションの互換性の問題に関する情報を確認します。
ms.date: 07/10/2019
...
ms.locfileid: "97009164"
---
# <a name="runtime-changes-for-migration-from-net-framework-45-to-462"></a><span data-ttu-id="dfbc4-103">.NET Framework 4.5 から 4.6.2 への移行に関するランタイム変更</span><span class="sxs-lookup"><span data-stu-id="dfbc4-103">Runtime Changes for Migration from .NET Framework 4.5 to 4.6.2</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="dfbc4-104">.NET Framework 4.5 から 4.6.2 に移行する場合は、アプリに影響する可能性があるアプリケーションの互換性の問題に関する次のトピックを確認してください。</span><span class="sxs-lookup"><span data-stu-id="dfbc4-104">If you are migrating from the .NET Framework 4.5 to 4.6.2, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="adonet"></a><span data-ttu-id="dfbc4-105">ADO.NET</span><span class="sxs-lookup"><span data-stu-id="dfbc4-105">ADO.NET</span></span>
...
## <a name="aspnet"></a><span data-ttu-id="dfbc4-106">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="dfbc4-106">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="dfbc4-107">コア</span><span class="sxs-lookup"><span data-stu-id="dfbc4-107">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="dfbc4-108">データ</span><span class="sxs-lookup"><span data-stu-id="dfbc4-108">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="dfbc4-109">デバッガー</span><span class="sxs-lookup"><span data-stu-id="dfbc4-109">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="dfbc4-110">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="dfbc4-110">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="dfbc4-111">グローバリゼーション</span><span class="sxs-lookup"><span data-stu-id="dfbc4-111">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="dfbc4-112">ネットワーキング</span><span class="sxs-lookup"><span data-stu-id="dfbc4-112">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="dfbc4-113">セキュリティ</span><span class="sxs-lookup"><span data-stu-id="dfbc4-113">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="dfbc4-114">シリアル化</span><span class="sxs-lookup"><span data-stu-id="dfbc4-114">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="dfbc4-115">セットアップと配置</span><span class="sxs-lookup"><span data-stu-id="dfbc4-115">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="dfbc4-116">ツール</span><span class="sxs-lookup"><span data-stu-id="dfbc4-116">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="dfbc4-117">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="dfbc4-117">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="dfbc4-118">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="dfbc4-118">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="dfbc4-119">XML</span><span class="sxs-lookup"><span data-stu-id="dfbc4-119">XML</span></span>
