---
title: .NET Framework 4.5.1 から 4.6.1 への移行に関するランタイム変更
description: .NET Framework 4.5.1 から 4.6.1 に移行するときに、ランタイムの変更からのアプリに影響する可能性があるアプリケーションの互換性の問題に関する情報を確認します。
ms.date: 07/10/2019
...
ms.locfileid: "97009873"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a><span data-ttu-id="43461-103">.NET Framework 4.5.1 から 4.6.1 への移行に関するランタイム変更</span><span class="sxs-lookup"><span data-stu-id="43461-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="43461-104">.NET Framework 4.5.1 から 4.6.1 に移行する場合は、アプリに影響する可能性があるアプリケーションの互換性の問題に関する次のトピックを確認してください。</span><span class="sxs-lookup"><span data-stu-id="43461-104">If you are migrating from the .NET Framework 4.5.1 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="43461-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="43461-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="43461-106">コア</span><span class="sxs-lookup"><span data-stu-id="43461-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="43461-107">データ</span><span class="sxs-lookup"><span data-stu-id="43461-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="43461-108">デバッガー</span><span class="sxs-lookup"><span data-stu-id="43461-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="43461-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="43461-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="43461-110">ネットワーキング</span><span class="sxs-lookup"><span data-stu-id="43461-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="43461-111">シリアル化</span><span class="sxs-lookup"><span data-stu-id="43461-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="43461-112">セットアップと配置</span><span class="sxs-lookup"><span data-stu-id="43461-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="43461-113">ツール</span><span class="sxs-lookup"><span data-stu-id="43461-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="43461-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="43461-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="43461-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="43461-115">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="43461-116">XML</span><span class="sxs-lookup"><span data-stu-id="43461-116">XML</span></span>
