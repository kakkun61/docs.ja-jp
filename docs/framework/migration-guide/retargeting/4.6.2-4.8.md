---
title: .NET Framework 4.6.2 から 4.8 への移行に関する変更の再ターゲット
description: .NET Framework 4.6.2 から 4.8 に移行するときに、アプリに影響する可能性があるアプリケーションの互換性の問題に関する情報を確認します。
ms.date: 07/10/2019
...
ms.locfileid: "95724235"
---
# <a name="retargeting-changes-for-migration-from-net-framework-462-to-48"></a><span data-ttu-id="c7b1c-103">.NET Framework 4.6.2 から 4.8 への移行に関する変更の再ターゲット</span><span class="sxs-lookup"><span data-stu-id="c7b1c-103">Retargeting Changes for Migration from .NET Framework 4.6.2 to 4.8</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/retargeting/versionselector.md)]

<span data-ttu-id="c7b1c-104">.NET Framework 4.6.2 から 4.8 に移行する場合は、アプリに影響する可能性があるアプリケーションの互換性の問題に関する次のトピックを確認してください。</span><span class="sxs-lookup"><span data-stu-id="c7b1c-104">If you are migrating from the .NET Framework 4.6.2 to 4.8, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="c7b1c-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="c7b1c-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="c7b1c-106">コア</span><span class="sxs-lookup"><span data-stu-id="c7b1c-106">Core</span></span>
...
## <a name="networking"></a><span data-ttu-id="c7b1c-107">ネットワーキング</span><span class="sxs-lookup"><span data-stu-id="c7b1c-107">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="c7b1c-108">セキュリティ</span><span class="sxs-lookup"><span data-stu-id="c7b1c-108">Security</span></span>
...
## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="c7b1c-109">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="c7b1c-109">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-forms"></a><span data-ttu-id="c7b1c-110">Windows フォーム</span><span class="sxs-lookup"><span data-stu-id="c7b1c-110">Windows Forms</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="c7b1c-111">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="c7b1c-111">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="c7b1c-112">Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="c7b1c-112">Windows Workflow Foundation (WF)</span></span>
